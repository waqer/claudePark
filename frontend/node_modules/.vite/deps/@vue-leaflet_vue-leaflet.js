...
import { Bn as markRaw, Ft as onMounted, Kn as ref, Ot as nextTick, U as computed, Ut as provide, Wn as reactive, gn as watch, jt as onBeforeUnmount, nt as defineComponent, p as render, pt as h$1, xt as inject, zt as onUnmounted } from "./vue.runtime.esm-bundler-DewitlPc.js";
//#region node_modules/@vue-leaflet/vue-leaflet/dist/vue-leaflet.es.js
var ce = (e, o) => {
	...
	const o = {}, t = {};
	for (const n in e) if (n.startsWith("on") && !n.startsWith("onUpdate") && n !== "onReady") {
	...
	const o = await Promise.all([
		import("C:/xampp/htdocs/claudePark/frontend/node_modules/leaflet/dist/images/marker-icon-2x.png"),
		import("C:/xampp/htdocs/claudePark/frontend/node_modules/leaflet/dist/images/marker-icon.png"),
		import("C:/xampp/htdocs/claudePark/frontend/node_modules/leaflet/dist/images/marker-shadow.png")
	]);
	...
	const o = ref((...n) => console.warn(`Method ${e} has been invoked without being replaced`)), t = (...n) => o.value(...n);
	...
	const o = inject(e);
	if (o === void 0) throw new Error(`Attempt to inject ${e.description} before it was provided.`);
	return o;
...
}, Symbol.toStringTag, { value: "Module" })), h = Symbol("useGlobalLeaflet"), M = Symbol("addLayer"), ee = Symbol("removeLayer"), H = Symbol("registerControl"), me = Symbol("registerLayerControl"), ve = Symbol("canSetParentHtml"), be = Symbol("setParentHtml"), fe = Symbol("setIcon"), ge = Symbol("bindPopup"), Le = Symbol("bindTooltip"), he = Symbol("unbindPopup"), Oe = Symbol("unbindTooltip"), Qt = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	AddLayerInjection: M,
...
}, Symbol.toStringTag, { value: "Module" })), W = { options: {
	type: Object,
	default: () => ({}),
	custom: !0
} }, J = (e) => ({
	...
	const n = m(M), s = m(ee), { options: r, methods: l } = J(e), a = f(e, D, r), i = () => n({ leafletObject: o.value }), u = () => s({ leafletObject: o.value }), d = {
		...l,
		setAttribution(y) {
	...
	if (e && o.default) return h$1("div", { style: { display: "none" } }, o.default());
	...
	const { options: n, methods: s } = q(e, o, t);
	return {
		options: f(e, Se, n),
		methods: s
	};
	...
	const { options: n, methods: s } = Ke(e, o, t), r = f(e, ne, n), l = m(ee), a = {
		...s,
		setStroke(i) {
	...
	const { options: n, methods: s } = _e(e, o, t);
	return {
		options: f(e, re, n),
		methods: {
			...s,
	...
	const { options: n, methods: s } = je(e, o, t);
	return {
		options: f(e, Pe, n),
		methods: { ...s }
	};
	...
	circleProps: Pe,
	setupCircle: Qe
}, Symbol.toStringTag, { value: "Module" })), Xt = defineComponent({
	name: "LCircle",
	props: Pe,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = Qe(e, t, o);
		return onMounted(async () => {
			const { circle: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			...
			}), n.value = !0, nextTick(() => o.emit("ready", t.value));
		}), {
			ready: n,
			leafletObject: t
		};
	...
	props: re,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = je(e, t, o);
		return onMounted(async () => {
			const { circleMarker: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(i(e.latLng, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
	...
	const { options: t, methods: n } = J(e), s = f(e, F, t), r = {
		...n,
		setPosition(l) {
	...
	renderLControl: Xe,
	setupControl: K
}, Symbol.toStringTag, { value: "Module" })), Vt = defineComponent({
	name: "LControl",
	props: {
		...F,
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { Control: i, DomEvent: u } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(new (i.extend({ onAdd() {
				return n.value;
			} }))(l)), L(a, t.value, e), r({ leafletObject: t.value }), e.disableClickPropagation && n.value && u.disableClickPropagation(n.value), e.disableScrollPropagation && n.value && u.disableScrollPropagation(n.value), nextTick(() => o.emit("ready", t.value));
		}), {
			root: n,
			leafletObject: t
		};
	...
	const { options: t, methods: n } = K(e, o);
	return {
		options: f(e, Ce, t),
		methods: {
			...n,
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(a.attribution(r)), L(l, t.value, e), s({ leafletObject: t.value }), nextTick(() => o.emit("ready", t.value));
		}), { leafletObject: t };
	},
	render() {
		return null;
...
}, Symbol.toStringTag, { value: "Module" })), Rt = defineComponent({
	name: "LControlLayers",
	props: Te,
	setup(e, o) {
		...
		return onMounted(async () => {
			const { control: a } = n ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(a.layers(void 0, void 0, r)), L(l, t.value, e), s({
				...e,
				...l,
				leafletObject: t.value
...
}, Symbol.toStringTag, { value: "Module" })), eo = defineComponent({
	name: "LControlScale",
	props: Me,
	setup(e, o) {
	...
	controlZoomProps: Be,
	setupControlZoom: Re
}, Symbol.toStringTag, { value: "Module" })), to = defineComponent({
	name: "LControlZoom",
	props: Be,
	setup(e, o) {
	...
	const { options: n, methods: s } = q(e, o, t), r = f(e, te, n), l = {
		...s,
		addLayer(a) {
	...
	return provide(M, l.addLayer), provide(ee, l.removeLayer), {
		options: r,
		methods: l
	};
	...
	layerGroupProps: te,
	setupLayerGroup: se
}, Symbol.toStringTag, { value: "Module" })), we = { ...te }, et = (e, o, t) => {
	const { options: n, methods: s } = se(e, o, t);
	return {
		options: f(e, we, n),
		methods: { ...s }
	};
...
}, Symbol.toStringTag, { value: "Module" })), oo = defineComponent({
	props: we,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { methods: l, options: a } = et(e, t, o);
		return onMounted(async () => {
			const { featureGroup: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(i(void 0, a));
			const { listeners: u } = T(o.attrs);
	...
	const { options: n, methods: s } = se(e, o, t), r = f(e, Ie, n);
	...
	geoJSONProps: Ie,
	setupGeoJSON: tt
}, Symbol.toStringTag, { value: "Module" })), no = defineComponent({
	props: Ie,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { methods: l, options: a } = tt(e, t, o);
		return onMounted(async () => {
			const { geoJSON: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	const { options: n, methods: s } = q(e, o, t), r = f(e, ae, n), l = {
		...s,
		setTileComponent() {
			var a;
	...
	createTile(s) {
		...
		return render(h$1({
			setup: n,
			props: ["coords"]
		}, { coords: s }), this.tileComponents[r]), this.tileComponents[r];
	},
	_unloadTile(s) {
	...
	gridLayerProps: ae,
	setupGridLayer: Ae
}, Symbol.toStringTag, { value: "Module" })), ro = defineComponent({
	props: {
		...ae,
		childRender: {
			type: Function,
	...
	setup(e, o) {
		const t = ref(), n = ref(null), s = ref(!1), r = inject(h), l = m(M), { options: a, methods: i } = Ae(e, t, o);
		return onMounted(async () => {
			const { GridLayer: u, DomUtil: d, Util: y } = r ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(new (ot(u, d, y, e.childRender))(a));
			const { listeners: v } = T(o.attrs);
			t.value.on(v), L(i, t.value, e), l({
				...e,
				...i,
				leafletObject: t.value
			}), s.value = !0, nextTick(() => o.emit("ready", t.value));
		}), {
			root: n,
			ready: s,
			leafletObject: t
	...
	setup(e, o) {
		...
		const w = (N, P, B) => {
			...
			y && i(y, E);
			const { options: ue } = J(e), $ = f(e, de, ue);
			I && ($.html = I), y = $.html ? u($) : d($), a(y, E), l(y);
		}, v = () => {
			nextTick(() => w(t.value, !0, !1));
		}, z = () => {
			nextTick(() => w(t.value, !1, !0));
		}, Z = {
			setIconUrl: v,
			setIconRetinaUrl: v,
			setIconSize: v,
		...
		return onMounted(async () => {
			const { DomEvent: N, divIcon: P, icon: B } = n ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	render() {
		return h$1("div", { ref: "root" }, this.$slots.default ? this.$slots.default() : void 0);
	}
}), Ge = {
	...D,
	opacity: { type: Number },
...
}, Symbol.toStringTag, { value: "Module" })), ao = defineComponent({
	name: "LImageOverlay",
	props: Ge,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = nt(e, t, o);
		return onMounted(async () => {
			const { imageOverlay: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(i(e.url, e.bounds, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
				...a,
	...
	props: te,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { methods: l } = se(e, t, o);
		return onMounted(async () => {
			const { layerGroup: a } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(a(void 0, e.options));
...
var We = {
	...
	setup(e, o) {
		const t = ref(), n = reactive({
			...
			layersToAdd: [],
			layersInControl: []
		}), { options: s } = J(e), r = f(e, We, s), { listeners: l, attrs: a } = T(o.attrs), i = Y(M), u = Y(ee), d = Y(H), y = Y(me);
		...
		onMounted(async () => {
			e.useGlobalLeaflet && (b.L = b.L || await import("./leaflet-src-C6jNEMBt.js").then((m) => /* @__PURE__ */ __toESM(m.default)));
			const { map: P, CRS: B, Icon: I, latLngBounds: E, latLng: ue, stamp: $ } = e.useGlobalLeaflet ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			try {
				r.beforeMapMount && await r.beforeMapMount();
			} catch (p) {
				console.error(`The following error occurred running the provided beforeMapMount hook ${p.message}`);
			}
			await qe(I);
			r.crs = (typeof r.crs == "string" ? B[r.crs] : r.crs) || B.EPSG3857;
			const Q = {
				addLayer(p) {
					p.layerType !== void 0 && (n.layerControl === void 0 ? n.layersToAdd.push(p) : n.layersInControl.find((X) => $(X.leafletObject) === $(p.leafletObject)) || (n.layerControl.addLayer(p), n.layersInControl.push(p))), p.visible !== !1 && n.leafletRef.addLayer(p.leafletObject);
				},
				removeLayer(p) {
					p.layerType !== void 0 && (n.layerControl === void 0 ? n.layersToAdd = n.layersToAdd.filter((C) => C.name !== p.name) : (n.layerControl.removeLayer(p.leafletObject), n.layersInControl = n.layersInControl.filter((C) => $(C.leafletObject) !== $(p.leafletObject)))), n.leafletRef.removeLayer(p.leafletObject);
				},
				...
				setZoom(p) {
					p !== n.leafletRef.getZoom() && n.leafletRef.setZoom(p, w.value);
				},
				setCrs(p) {
			...
			V(i, Q.addLayer), V(u, Q.removeLayer), V(d, Q.registerControl), V(y, Q.registerLayerControl), n.leafletRef = markRaw(P(t.value, r)), L(Q, n.leafletRef, e), ce(n.leafletRef, z), ce(n.leafletRef, l), n.ready = !0, nextTick(() => o.emit("ready", n.leafletRef));
		}), onBeforeUnmount(() => {
			ye(z), n.leafletRef && (n.leafletRef.off(), n.leafletRef.remove());
		});
		const Z = computed(() => n.leafletRef);
		return {
			root: t,
			ready: computed(() => n.ready),
			leafletObject: Z,
			attrs: a
		};
	},
	render({ attrs: e }) {
		return e.style || (e.style = {}), e.style.width || (e.style.width = "100%"), e.style.height || (e.style.height = "100%"), h$1("div", {
			...e,
			ref: "root"
...
var $t = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	markerProps: ze,
	setupMarker: st,
	shouldBlankIcon: at
	...
	props: ze,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M);
		provide(ve, () => {
			var u;
		...
		const { options: l, methods: a } = st(e, t, o), i = { moveHandler: rt(a.latLngSync) };
		return onMounted(async () => {
			const { marker: u, divIcon: d } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	polylineProps: le,
	setupPolyline: Ne
}, Symbol.toStringTag, { value: "Module" })), x = { ...le }, $e = (e, o, t) => {
	const { options: n, methods: s } = Ne(e, o, t);
	return {
		options: f(e, x, n),
		methods: {
			...s,
	...
	polygonProps: x,
	setupPolygon: $e
}, Symbol.toStringTag, { value: "Module" })), co = defineComponent({
	name: "LPolygon",
	props: x,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = $e(e, t, o);
		return onMounted(async () => {
			const { polygon: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	props: le,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = Ne(e, t, o);
		return onMounted(async () => {
			const { polyline: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(i(e.latLngs, l));
			const { listeners: u } = T(o.attrs);
			t.value.on(u), L(a, t.value, e), r({
				...e,
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { popup: u } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	const { options: n, methods: s } = $e(e, o, t);
	return {
		options: f(e, Fe, n),
		methods: {
			...s,
	...
	rectangleProps: Fe,
	setupRectangle: ut
}, Symbol.toStringTag, { value: "Module" })), mo = defineComponent({
	name: "LRectangle",
	props: Fe,
	setup(e, o) {
		const t = ref(), n = ref(!1), s = inject(h), r = m(M), { options: l, methods: a } = ut(e, t, o);
		return onMounted(async () => {
			const { rectangle: i, latLngBounds: u } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(i(e.bounds ? u(e.bounds) : u(e.latLngs || []), l));
			const { listeners: y } = T(o.attrs);
	...
	const { options: n, methods: s } = Ae(e, o, t);
	return {
		options: f(e, ie, n),
		methods: { ...s }
	};
	...
	setup(e, o) {
		...
		return onMounted(async () => {
			const { tileLayer: a } = n ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
	...
	setupTooltip: dt,
	tooltipProps: ct
}, Symbol.toStringTag, { value: "Module" })), bo = defineComponent({
	name: "LTooltip",
	props: ct,
	setup(e, o) {
		const t = ref(), n = ref(null), s = inject(h), r = m(Le), { options: l, methods: a } = dt(e, t);
		return onMounted(async () => {
			const { tooltip: i } = s ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
...
}, Symbol.toStringTag, { value: "Module" })), fo = defineComponent({
	props: Ee,
	setup(e, o) {
		const t = ref(), n = inject(h), s = m(M), { options: r, methods: l } = pt(e, t, o);
		return onMounted(async () => {
			const { tileLayer: a } = n ? b.L : await import("./leaflet-src.esm-DLxK8o0p.js");
			t.value = markRaw(a.wms(e.url, r));
			const { listeners: i } = T(o.attrs);
			t.value.on(i), L(l, t.value, e), s({
				...e,
				...l,
...
//#endregion
export { go as Functions, Qt as InjectionKeys, Xt as LCircle, Yt as LCircleMarker, Vt as LControl, xt as LControlAttribution, Rt as LControlLayers, eo as LControlScale, to as LControlZoom, oo as LFeatureGroup, no as LGeoJson, ro as LGridLayer, so as LIcon, ao as LImageOverlay, lo as LLayerGroup, io as LMap, uo as LMarker, co as LPolygon, po as LPolyline, yo as LPopup, mo as LRectangle, vo as LTileLayer, bo as LTooltip, fo as LWmsTileLayer, Kt as Utilities };
